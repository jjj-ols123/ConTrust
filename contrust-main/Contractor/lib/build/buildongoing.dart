      ...
      case 'Materials':
        content = buildSectionCard(
          ...
          child: buildCostsList(
            ...
            onViewMaterial: (material) => CorOngoingBuildMethods.showMaterialDetailsDialog(context, material),
          ),
        );
        break;
      default:
                    ...
                    children: [
                      ...
                      Expanded(
                        child: buildGridSectionCard(
                          ...
                          icon: Icons.description,
                          iconColor: Colors.grey,
                          onAdd: () => generatePDFReport(context, tasks, reports, photos, costs),
                    ...
                    children: [
                      Expanded(
                        child: buildGridSectionCard(
                          ...
                          onAdd: onAddPhoto,
                          addButtonText: 'Add Photo',
                          child: CorOngoingBuildMethods.buildDesktopPhotosList(
                            photos: photos,
                            createSignedUrl: createSignedUrl,
                            onDeletePhoto: onDeletePhoto,
                            onViewPhoto: onViewPhoto,
                      ...
                      Expanded(
                        child: buildGridSectionCard(
                          ...
                          onAdd: onGoToMaterials,
                          addButtonText: 'Manage Materials',
                          child: CorOngoingBuildMethods.buildDesktopCostsList(
                            costs: costs,
                            onDeleteCost: onDeleteCost,
                            onViewMaterial:
                                (material) => CorOngoingBuildMethods.showMaterialDetailsDialog(
                                  context,
                                  material,
                                ),
                          ),
      ...
      children: [
        Padding(
          ...
          child: SizedBox(
            width: double.infinity,
            child: ElevatedButton.icon(
              onPressed: () => generatePDFReport(context, tasks, reports, photos, costs),
